    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 p-6">
      <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-6 bg-gradient-to-r from-purple-500 to-pink-500 p-6 rounded-2xl text-white shadow-lg">
              ...
              <div className="flex gap-3">
                <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-lg">
                  <p className="text-xs text-purple-100">Current Streak</p>
                  <p className="text-2xl font-bold">{streak} days</p>
                </div>
                <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-lg">
                  <p className="text-xs text-purple-100">Next Milestone</p>
                  <p className="text-2xl font-bold">
                    {streak < 7 && '7 days'}
                    {streak >= 7 && streak < 14 && '14 days'}
                    {streak >= 14 && streak < 30 && '30 days'}
                    {streak >= 30 && 'Complete! 🎉'}
                  </p>
                </div>
              </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          <button className="bg-white hover:bg-blue-50 border-2 border-blue-500 text-blue-600 p-4 rounded-xl font-semibold transition-all hover:shadow-lg flex items-center justify-center gap-2">
            <span className="text-2xl">📝</span>
            Take a Quiz
          </button>
          <button className="bg-white hover:bg-green-50 border-2 border-green-500 text-green-600 p-4 rounded-xl font-semibold transition-all hover:shadow-lg flex items-center justify-center gap-2">
            <span className="text-2xl">🃏</span>
            Practice Flashcards
          </button>
          <button className="bg-white hover:bg-purple-50 border-2 border-purple-500 text-purple-600 p-4 rounded-xl font-semibold transition-all hover:shadow-lg flex items-center justify-center gap-2">
            <span className="text-2xl">📊</span>
            View Detailed Stats
          </button>
        </div>
